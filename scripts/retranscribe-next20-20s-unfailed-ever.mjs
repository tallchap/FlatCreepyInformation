...
const VIDEO_DELAY_MS = 20000;
const MIN_SEGMENTS_PER_MIN = 1;

const START_AFTER_ID = "HwMQld8GdMc";
...
async function main() {
  ...
  const outPath = path.resolve(process.cwd(), "scripts/retranscribe-next20-20s-unfailed-ever.results.json");
  ...
  try {
    ...
    const merged = {
      ...
      source: "scripts/retranscribe-next20-20s-unfailed-ever.results.json",
      count: map.size,
