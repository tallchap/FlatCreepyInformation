...
async function main() {
  ...
  const outPath = path.resolve(process.cwd(), "scripts/retranscribe-next20-10s-unfailed-ever.results.json");
  ...
  try {
    ...
    const merged = {
      ...
      source: "scripts/retranscribe-next20-10s-unfailed-ever.results.json",
      count: map.size,
